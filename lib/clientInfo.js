...
(function(){
  ...
  // 获取操作系统
  ITReportError.prototype.getOs = function () {
  ...
  // 获取操作系统版本号
  ITReportError.prototype.getDigits = function () {
    let sUserAgent = navigator.userAgent.toLowerCase()
  ...
  // 获取浏览器
  ITReportError.prototype.getBrowser = function () {
  ...
  ITReportError.prototype.init = function() {
